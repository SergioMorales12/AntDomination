...
## Descripción
AntDomination es un innovador juego de estrategia en **Realidad Mixta (MR)** que convierte tu entorno físico en un campo de batalla mirmecológico. Un hormiguero emerge directamente del suelo de tu habitación, y tu misión es expandir tu imperio, criar insectos gladiadores y asegurar la supervivencia de tu especie frente a colonias rivales.
...
- Dispositivos compatibles con Passthrough de alta fidelidad (ej. Meta Quest 3).
- Espacio de juego despejado para una mejor experiencia de mapeado.

## Licencia
Este proyecto es una idea conceptual. Todos los derechos reservados.
